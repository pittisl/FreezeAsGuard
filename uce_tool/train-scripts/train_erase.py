...
if __name__ == '__main__':
    ...
    parser.add_argument('--base', help='base version for stable diffusion', type=str, required=False, default='1.5')
    ...
    parser.add_argument('--save_path', help='path to the processed model', type=str, required=True)
    ...
    erased_concept = copy.deepcopy(print_text)
    ...
    ldm_stable.save_pretrained(f"{args.save_path}")
